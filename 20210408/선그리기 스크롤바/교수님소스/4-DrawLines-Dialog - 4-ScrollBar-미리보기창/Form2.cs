...
namespace DrawLines
{
    public partial class Form2 : Form
    {
        ...
        private void label5_Paint(object sender, PaintEventArgs e)
        {
            ...
            //G.DrawLine(new Pen(DialogPenColor, iDialogPenWidth), 
            //    0, 0, this.Width, this.Height);
            e.Graphics.DrawLine(new Pen(DialogPenColor, iDialogPenWidth),
                0, label5.Height/2, label5.Width, label5.Height/2);
        }
    }
}
