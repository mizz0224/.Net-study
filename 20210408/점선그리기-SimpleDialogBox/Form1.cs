...
namespace mixControl
{
    public partial class Form1 : Form
    {
        ...
        {
            Form2 dlg=new Form2();
            dlg.Pcolor = CurrentColor;
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                CurrentColor = dlg.Pcolor;    
            }
        ...
        {
            iCurrentWidth = comboBox1.SelectedIndex;
        }
        ...
        private void comboBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                iCurrentWidth = int.Parse(comboBox1.Text);
            }
            catch
            {
                comboBox1.Text = iCurrentWidth.ToString();
            }
        }
    }
